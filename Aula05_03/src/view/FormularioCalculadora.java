...
public class FormularioCalculadora {
    ...
    private void inicializarComponentes() {
        ...
        form.setBounds(300, 150, 500, 300);
        form.setLayout(null);
        ...
        btnSomar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                float resultado = objAdicao.calcular(valor1, valor2);
        ...
        btnSubtrair.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                lblResultado.setText(
                    String.format(
                        "Resultado: %.2f", 
                            new Subtracao().calcular(
                                Float.parseFloat(txtValor1.getText()), 
                                Float.parseFloat(txtValor2.getText()))));
            }
        });
